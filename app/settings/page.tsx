...
function SectionError({ message, onRetry }: { message: string; onRetry: () => void }) { return <div className="rounded-xl border border-rose-400/20 bg-rose-500/[.07] p-3 text-sm text-rose-100"><p>{message}</p><button type="button" onClick={onRetry} className="mt-2 font-medium text-sky-300">Retry</button></div>; }
